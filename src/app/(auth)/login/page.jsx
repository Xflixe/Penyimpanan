...
import { loginUser } from '@/lib/auth'; // Assuming loginUser is an API function in your auth.js
import { account } from '@/lib/appwrite'; // Assuming Appwrite client setup is in appwrite.js
